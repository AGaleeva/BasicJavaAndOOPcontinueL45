...
public class StringsToFrequentWords {
     /*
        ** Задача 1 **
        ...
        2. Получить Map<String, Integer> - ключ - это слово, значение - сколько раз оно встретилось.
        3. Можно получить другую Map: Map<String, Integer> -> Map<Integer, List<String>>
        */

    public static void main(String[] args) {
        List<String> list = List.of("11 22 33 11 22 33 22 22 22", "11 333 222 22", "44 22 11 44");
        ...
        System.out.println("=================================================");
        TreeMap<Integer, List<String>> mapCount = toMapCountListWords(wordCountMap);
        getFreqWords2(mapCount, 4);
    }
